...
@CamelSpringBootTest
@SpringBootTest(classes = {CamelAutoConfiguration.class, BeanTypesRouteBuilder.class})
@ActiveProfiles("beans")
@MockEndpoints
class BeanTypesRouteBuilderTest {

    @Autowired
    private ProducerTemplate producerTemplate;

    @EndpointInject("mock:direct:beanOut")
    private MockEndpoint beanOut;

    @Test
    void basicBeanRoute() throws InterruptedException {
        ...
        producerTemplate.sendBody("direct:beanIn", Type1.of("abc"));
